...
// Variables
const rootDomain = "rukhimubarok04.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "rukhi"; // Ganti dengan nama workers kalian
const apiKey = "6e72d2a47d7d98426fee4fa67fe0754621e8a"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "rukhimubarok04@gmail.com"; // Ganti dengan email yang kalian gunakan
